...
public class ApplicationDbContextInitialiser
{
    ...
    public async Task TrySeedAsync()
    {
        ...
        //        Cards =
        //        {
        //            new Card(){ Name = "Make a todo list 📃" }
        //            //,new Card { Name = "Check off the first item ✅" }
        //            //,new Card { Name = "Realise you've already done two things on the list! 🤯"}
        //            //,new Card { Name = "Reward yourself with a nice, long nap 🏆" },
        //        }
        //    });
