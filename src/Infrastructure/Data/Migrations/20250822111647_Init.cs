        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandModifier = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    ImageUrisId = table.Column<int>(type: "INTEGER", nullable: true),
                    HighResImage = table.Column<bool>(type: "INTEGER", nullable: true),
                    Reprint = table.Column<bool>(type: "INTEGER", nullable: true),
                    Digital = table.Column<bool>(type: "INTEGER", nullable: true),
                    ...
                    FullArt = table.Column<bool>(type: "INTEGER", nullable: true),
                    Watermark = table.Column<string>(type: "TEXT", nullable: true),
                    BorderColor = table.Column<int>(type: "INTEGER", nullable: true),
                    StorySpotlightNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    StorySpotlightUri = table.Column<string>(type: "TEXT", nullable: true),
                    Timeshifted = table.Column<bool>(type: "INTEGER", nullable: true),
                    Colorshifted = table.Column<bool>(type: "INTEGER", nullable: true),
                    Futureshifted = table.Column<bool>(type: "INTEGER", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "TEXT", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_ImageUri_ImageUrisId",
